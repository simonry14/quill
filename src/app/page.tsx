    ...
    <>
      <MaxWidthWrapper className='mb-8 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        <h1 className='max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl'>
          Chat with your{' '}
          <span className='text-blue-600'>Ugandan Law Documents</span>{' '}
          in seconds.
        </h1>
        <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
          UGLawyer allows you to have conversations with any
          Uganda Law PDF document. Simply ask about different cases, law principles and so on. You can also upload your file and start
